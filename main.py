...
def loginMySAT(logins):
    ...
    elementIdpUsername.send_keys(logins[0]) # Enter required email, to be prompted in next update if required
    ...
    try:
        ...
        elementIdpPasswd.send_keys(logins[1]) # Enter required password TODO: remove password before pushing to GitHub!!!!!!
...
while(1):
    try:
        ...
        print("Logging in")
        loginMySAT(logincreds[iterator])
